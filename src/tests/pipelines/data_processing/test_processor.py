...
class TestModeImpute(object):
    ...
    def test_impute(self, epc_input):
        ...
        df_expected = pd.DataFrame(
            data=[
                [3.25e+05, 3, 2.5, 'Hendrik De Braekeleerlaan 68', 2.59e+02],
                [1.74e+05, 2, 2.5, 'Antwerpsesteenweg 50', 6.44e+02],
                [1.74e+05, 2, 4, 'Antwerpsesteenweg 5', 6.44e+02],
                [1.99e+05, 2, 2.5, 'Hoevelei 194', 2.06e+02],
                [2.39e+05, 2, 1, 'Leon Gilliotlaan 40', 2.29e+02],
                [2.85e+05, 3, 2.5, 'De Cranelei 9', 4.40e+01],
                [3.69e+05, 1, 2.5, 'Kapellestraat 159', 0.00e+00],
    ...
    def test_impute_with_mode(self, epc_input):
        ...
        expected = pd.Series([10, 2.5, 4, 2.5, 1, 10, 2.5, 3], name='Facades')
        assert_series_equal(actual, expected, check_dtype=False)
